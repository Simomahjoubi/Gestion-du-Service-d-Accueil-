...
-- New fonctionnaires and Chef de service for Estivage service
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_estivage_1', 'Fonctionnaire Estivage 1', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Estivage'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_estivage_2', 'Fonctionnaire Estivage 2', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Estivage'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_estivage_3', 'Fonctionnaire Estivage 3', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Estivage'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_estivage_4', 'Fonctionnaire Estivage 4', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Estivage'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('chef_estivage', 'Chef Service Estivage', 'FONCTIONNAIRE', 1, 1, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Estivage'));

-- New fonctionnaires and Chef de service for Médicale service
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_medicale_1', 'Fonctionnaire Médicale 1', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Médicale'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_medicale_2', 'Fonctionnaire Médicale 2', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Médicale'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_medicale_3', 'Fonctionnaire Médicale 3', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Médicale'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_medicale_4', 'Fonctionnaire Médicale 4', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Médicale'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('chef_medicale', 'Chef Service Médicale', 'FONCTIONNAIRE', 1, 1, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Médicale'));

-- New fonctionnaires and Chef de service for RH service
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_rh_1', 'Fonctionnaire RH 1', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='RH'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_rh_2', 'Fonctionnaire RH 2', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='RH'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_rh_3', 'Fonctionnaire RH 3', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='RH'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_rh_4', 'Fonctionnaire RH 4', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='RH'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('chef_rh', 'Chef Service RH', 'FONCTIONNAIRE', 1, 1, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='RH'));

-- New fonctionnaires and Chef de service for Prêts "&" Aides service
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_aides_1', 'Fonctionnaire Prêts "&" Aides 1', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Prêts "&" Aides'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_aides_2', 'Fonctionnaire Prêts "&" Aides 2', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Prêts "&" Aides'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_aides_3', 'Fonctionnaire Prêts "&" Aides 3', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Prêts "&" Aides'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_aides_4', 'Fonctionnaire Prêts "&" Aides 4', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Prêts "&" Aides'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('chef_aides', 'Chef Service Prêts "&" Aides', 'FONCTIONNAIRE', 1, 1, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Prêts "&" Aides'));

-- New fonctionnaires and Chef de service for Formation "&" Culture service
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_culture_1', 'Fonctionnaire Formation "&" Culture 1', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Formation "&" Culture'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_culture_2', 'Fonctionnaire Formation "&" Culture 2', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Formation "&" Culture'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_culture_3', 'Fonctionnaire Formation "&" Culture 3', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Formation "&" Culture'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('f_culture_4', 'Fonctionnaire Formation "&" Culture 4', 'FONCTIONNAIRE', 1, 0, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Formation "&" Culture'));
INSERT INTO utilisateurs (username, nom_complet, role, actif, is_chef, statut_presence, date_creation, service_id) 
VALUES ('chef_culture', 'Chef Service Formation "&" Culture', 'FONCTIONNAIRE', 1, 1, 'DISPONIBLE', GETDATE(), (SELECT id FROM services WHERE nom='Formation "&" Culture'));
...
INSERT INTO visites (visiteur_id, service_id, objet_visite_id, fonctionnaire_id, agent_accueil_id, badge_id, statut, heure_arrivee, heure_cloture, notes)
VALUES (
    (SELECT id FROM visiteurs WHERE cin='CD789012'), -- Siham Bennani
    (SELECT id FROM services WHERE nom='Médicale'),
    (SELECT id FROM objet_visite WHERE code='MED_PEC'),
    (SELECT id FROM utilisateurs WHERE username='f_khadija'),
    (SELECT id FROM utilisateurs WHERE username='agent_ahmed'),
    (SELECT id FROM badges WHERE code='MED-01'),
    'EN_COURS',
    GETDATE(),
    NULL,
    'Demande de prise en charge pour examen'
);
